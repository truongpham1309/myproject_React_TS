...
const ProductsListPage = () => {
    ...
    return (
        <div>
            <h1 className="font-bold text-left w-[80%] mx-auto text-2xl my-5">Products List</h1>
            <div className="grid grid-cols-4 w-[80%] mx-auto mt-4 gap-4">
                {products.map(product => (
                    <div key={product.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img
                                className="p-2 w-full rounded-t-lg"
                                src={product.image}
                                alt="product image"
                            />
                        </a>
