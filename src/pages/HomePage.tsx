const HomePage = () => {
    return (
        <div className="md:my-8 my-0 mx-auto max-w-screen-lg bg-white md:border-t-2 border-gray-400">          
            ...
            <footer className="py-6 px-1 text-center bg-gray-100 border-t border-gray-200">
                <a href="#" className="text-xs font-bold text-gray-600 hover:underline">
                    Proudly powered by Tailwind CSS
                </a>
            </footer>
        </div>
